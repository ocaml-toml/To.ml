...
(* OASIS_START *)
(* DO NOT EDIT (digest: cf8d52989df2e6f7154272261b8840ee) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_toml", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("parser_with_coverage",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [
                      (OASISExpr.EBool true,
                        ("BISECT_FILE=../_build/coverage", ["$test_toml"]))
                   ];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "TOML aims to be a minimal configuration file format that's easy to read due to obvious semantics. TOML is designed to map unambiguously to a hash table. This library implement parsing and printing TOML from OCaml datastructures."
              ];
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Toml"; "TomlTypes"; "TomlLenses"];
                      lib_pack = false;
               ...
               Flag
                 ({
                  ...
                  },
                   {
                      flag_description =
                        Some
                          "Generate code coverage report (need tests enabled)";
                        ...
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "tests",
                                OASISExpr.ENot (OASISExpr.EFlag "report")),
                             true)
                        ];
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "test_toml"
                        ]
                   });
               Test
                 ({
                     cs_name = "parser_with_coverage";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for To.ml";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/mackwic/To.ml.git";
                      src_repo_browser =
                        Some "https://github.com/mackwic/To.ml";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\029\169d\192c\199p=\223\136\136\158?3\154\030";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
